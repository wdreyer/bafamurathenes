...
.mura .hand { font-family: 'Caveat', cursive; font-weight: 600; opacity: 0.85; }
...
function CallbackWidget({ position = "br" }) {
  ...
  return (
    <div style={{ position: "absolute", ...pos, zIndex: 20, width: 360 }}>
      <div style={{ background: M.ink, color: M.cream, borderRadius: 20, padding: 22, boxShadow: `4px 4px 0 ${M.violet}`, border: `2px solid ${M.violet}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
          <div>
            ...
            <div className="ed" style={{ fontSize: 26, fontWeight: 600, lineHeight: 1.05, fontStyle: "italic" }}>
              Une question ?<br />On vous appelle.
            </div>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 14 }}>
          <input placeholder="Votre prénom" style={{ width: "100%", background: "transparent", border: `1px solid ${M.cream}33`, borderRadius: 8, padding: "10px 12px", color: M.cream, fontSize: 13, fontFamily: "inherit" }} />
          <input placeholder="Votre numéro" style={{ width: "100%", background: "transparent", border: `1px solid ${M.cream}33`, borderRadius: 8, padding: "10px 12px", color: M.cream, fontSize: 13, fontFamily: "inherit" }} />
  ...
  return (
    <div style={{ position: "sticky", bottom: 0, zIndex: 25, background: M.violet, color: M.cream, padding: "14px 48px", display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: `2px solid ${M.ink}` }}>
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 15, fontWeight: 700 }}>Pas sûr·e ? On vous aide à choisir.</div>
...
// Trust band — institutional reassurance for parents
function TrustBand() {
  const items = [
    { num: "240+", label: "animateur·rices formé·es depuis 2019" },
    { num: "100%", label: "encadrement diplômé BAFD / BPJEPS" },
    { num: "16", label: "stagiaires max par session — suivi individuel" },
    { num: "Agréé", label: "Jeunesse & Sports · DRAJES Auvergne-Rhône-Alpes" },
  ];
  return (
    <div style={{ background: M.paper, padding: "36px 48px", borderBottom: `1.5px solid ${M.ink}22` }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32 }}>
        {items.map((it, i) => (
          <div key={i} style={{ borderLeft: i === 0 ? "none" : `1.5px solid ${M.ink}22`, paddingLeft: i === 0 ? 0 : 24 }}>
            <div style={{ fontSize: 32, fontWeight: 700, color: M.violet, letterSpacing: -1, lineHeight: 1, marginBottom: 8 }}>{it.num}</div>
            <div className="mono" style={{ fontSize: 11, color: M.ink, opacity: 0.7, letterSpacing: 1.2, lineHeight: 1.45, textTransform: "uppercase" }}>{it.label}</div>
          </div>
        ))}
      </div>
    </div>
...
function HomeHero() {
  return (
    <div style={{ position: "relative", background: M.ink, color: M.cream, overflow: "hidden", minHeight: 780, borderBottom: `1.5px solid ${M.ink}` }}>
      {/* Vidéo en background */}
      <video
        src="public/hero.mp4"
        autoPlay
      ...
      />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(26,21,48,0.35) 0%, rgba(26,21,48,0.55) 55%, rgba(26,21,48,0.85) 100%)" }} />

      {/* Sticker promo en haut à gauche */}
      <div style={{ position: "absolute", top: 36, left: 48, zIndex: 2, transform: "rotate(-1deg)" }}>
      ...
      {/* Citation manifeste — en haut à droite, pull-quote éditorial */}
      <div style={{ position: "absolute", top: 100, right: 48, zIndex: 2, maxWidth: 380, textAlign: "right" }}>
        <div style={{ fontSize: 56, lineHeight: 0.4, color: M.yellow, fontFamily: "Georgia, serif", marginBottom: 0, opacity: 0.9 }}>"</div>
        <p className="ed" style={{ fontSize: 22, fontStyle: "italic", lineHeight: 1.35, color: M.cream, margin: "0 0 14px 0", fontWeight: 500, letterSpacing: -0.3 }}>
          Créer des espaces de joie et de paix où chaque jeune existe, compte et est valorisé.
        </p>
        <div className="mono" style={{ fontSize: 10, color: M.yellow, letterSpacing: 2, fontWeight: 700, textTransform: "uppercase", opacity: 0.9 }}>
      ...
      <div style={{ position: "absolute", bottom: 80, left: 48, zIndex: 2, maxWidth: 760 }}>
        <div className="hand" style={{ fontSize: 36, color: M.yellow, transform: "rotate(-1.5deg)", marginBottom: -8, marginLeft: 8 }}>passez votre</div>
      ...
      {/* Sticker Cantal — repositionné en bas à droite */}
      <div style={{ position: "absolute", bottom: 220, right: 60, zIndex: 2, width: 130, height: 130, borderRadius: "50%", background: M.ochre, color: M.ink, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", border: `3px solid ${M.ink}`, transform: "rotate(4deg)", boxShadow: `3px 3px 0 ${M.ink}` }}>
  ...
  return (
    <div style={{ background: M.cream, padding: "100px 48px", borderBottom: `1.5px solid ${M.ink}` }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 56, gap: 32 }}>
        ...
        <div className="hand" style={{ fontSize: 26, color: M.ink, transform: "rotate(-1deg)", maxWidth: 280, textAlign: "right" }}>
          réservez vite — les places<br />partent en quelques semaines ↓
        </div>
      </div>
      ...
      <div style={{ marginTop: 48, padding: 28, background: M.violetSoft, borderRadius: 24, border: `2px solid ${M.ink}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div className="mono" style={{ fontSize: 11, color: M.violet, fontWeight: 700, letterSpacing: 1.5, marginBottom: 6 }}>💸 FREIN BUDGET ? ON VOUS AIDE.</div>
          <div style={{ fontSize: 17, color: M.ink, fontWeight: 500, lineHeight: 1.4 }}>Aides CAF/locales, paiement en plusieurs fois, situations particulières — on regarde avec vous.</div>
        </div>
        ...
        {values.map((v, i) => (
          <div key={i} style={{ padding: 32, borderRight: i < values.length - 1 ? `1.5px solid ${M.ink}` : "none", display: "flex", flexDirection: "column", gap: 18 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              <div style={{ width: 44, height: 44, borderRadius: 12, background: v.color, color: M.cream, display: "flex", alignItems: "center", justifyContent: "center", border: `2px solid ${M.ink}`, transform: "rotate(-1.5deg)" }}>
    ...
    <div style={{ background: M.ink, padding: "100px 48px", color: M.cream, borderBottom: `1.5px solid ${M.ink}` }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 56 }}>
        <h2 style={{ fontSize: 84, fontWeight: 700, letterSpacing: -3, lineHeight: 0.95, margin: 0, maxWidth: 800 }}>
          Ils & elles l'ont fait <span className="ed" style={{ fontStyle: "italic", color: M.yellow }}>avant vous.</span>
        </h2>
...
function HomeCTA() {
  return (
    <div style={{ background: M.ochre, padding: "100px 48px", borderBottom: `2px solid ${M.ink}`, position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -40, right: 60, transform: "rotate(7.5deg)" }}>
...
function BafaPage() {
  const steps = [
    ...
    { num: "02", color: M.green, title: "Stage pratique", duration: "14 jours", text: "Sur le terrain, auprès d'un vrai public — centre de loisirs, séjour, périscolaire. Mise en pratique, travail en équipe. Murathènes vous accompagne via son réseau.", progress: "66%" },
    { num: "03", color: M.ochre, title: "Approfondissement", duration: "8 jours", text: "Dernière semaine pour valider votre BAFA. Retours sur stages, consolidation des acquis, approfondissement d'une thématique au choix.", progress: "100%" },
  ];
  return (
    <div className="mura" style={{ background: M.cream, color: M.ink, width: "100%" }}>
      <MNav />
      <div style={{ position: "relative", background: M.ink, color: M.cream, padding: "80px 48px 96px", overflow: "hidden", borderBottom: `1.5px solid ${M.ink}` }}>
        <Photo src="public/photos/fg-04.png" alt="BAFA Murathenes - portraits" ratio="auto" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} objectPosition="center 30%" />
        ...
        <div style={{ position: "relative", maxWidth: 1100 }}>
          ...
          <h1 style={{ fontSize: 124, fontWeight: 700, letterSpacing: -5, lineHeight: 0.9, margin: 0 }}>
            Votre premier pas dans <span className="ed" style={{ fontStyle: "italic", color: M.ochre }}>l'animation.</span>
          </h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, maxWidth: 1280, alignItems: "flex-start" }}>
          <div>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.65, color: M.ink, opacity: 0.85, marginBottom: 18 }}>
              Avec le BAFA, vous donnez vie au collectif : vous construisez des projets <strong>avec</strong> et <strong>pour</strong> les jeunes. Vous créez des souvenirs inoubliables, des moments de vie exceptionnels, en toute sécurité.
            </p>
            ...
            <div style={{ marginTop: 32, padding: "16px 22px", background: M.yellow, borderRadius: 999, border: `2px solid ${M.ink}`, display: "inline-flex", alignItems: "center", gap: 10, transform: "rotate(-1deg)" }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: M.ink }}>Vous pouvez vous inscrire dès vos 16 ans révolus.</span>
            </div>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto auto", gap: 12 }}>
            <div style={{ gridColumn: "1 / 3", border: `2px solid ${M.ink}`, borderRadius: 16, overflow: "hidden", boxShadow: `3px 3px 0 ${M.violet}` }}>
              <Photo src="public/photos/fg-05.png" alt="Domaine de Gravieres" ratio="16/9" />
            </div>
            <div style={{ border: `2px solid ${M.ink}`, borderRadius: 16, overflow: "hidden", transform: "rotate(-1deg)" }}><Photo src="public/photos/fg-02.png" alt="journaling - reflexion" ratio="1/1" /></div>
            <div style={{ border: `2px solid ${M.ink}`, borderRadius: 16, overflow: "hidden", transform: "rotate(1deg)" }}><Photo src="public/photos/fg-06.png" alt="grand jeu" ratio="1/1" /></div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: M.violetSoft, padding: "100px 48px", borderBottom: `1.5px solid ${M.ink}` }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {steps.map((s, i) => (
            <div key={i} style={{ background: M.paper, border: `2px solid ${M.ink}`, borderRadius: 24, padding: 32, boxShadow: `3px 3px 0 ${M.ink}`, display: "flex", flexDirection: "column", gap: 18 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
      ...
      <div style={{ background: M.cream, padding: "100px 48px", borderBottom: `1.5px solid ${M.ink}` }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", gap: 56, maxWidth: 1280 }}>
          ...
          <div style={{ border: `2px solid ${M.ink}`, borderRadius: 24, overflow: "hidden", boxShadow: `4px 4px 0 ${M.ochre}` }}>
            <Photo src="public/photos/fg-01.png" alt="scénette - atelier" ratio="3/4" />
          </div>
        </div>
  ...
  return (
    <div className="mura" style={{ background: M.cream, color: M.ink, width: "100%" }}>
      ...
      <div style={{ position: "relative", background: M.ink, color: M.cream, padding: "72px 48px 100px", overflow: "hidden", borderBottom: `1.5px solid ${M.ink}` }}>
        <Photo src="public/photos/fg-05.png" alt="infos pratiques - domaine" ratio="auto" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} objectPosition="center 50%" />
    ...
    <div className="mura" style={{ background: M.cream, color: M.ink, width: "100%" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 32, flexWrap: "wrap" }}>
              <button style={{ background: M.ochre, color: M.ink, border: `2px solid ${M.ink}`, borderRadius: 999, padding: "16px 26px", fontSize: 14, fontWeight: 700, letterSpacing: 0.5, textTransform: "uppercase", cursor: "pointer", boxShadow: `2px 2px 0 ${M.ink}` }}>
                Je m'inscris (550 €) →
              </button>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ border: `3px solid ${M.ink}`, borderRadius: 8, boxShadow: `4px 4px 0 ${M.ink}`, transform: "rotate(1deg)", overflow: "hidden" }}>
              <Photo src="public/photos/fg-05.png" alt="Domaine de Gravieres" ratio="4/3" />
            </div>
            <div style={{ position: "absolute", bottom: -40, left: -30, width: 180, transform: "rotate(-3deg)", border: `3px solid ${M.ink}`, borderRadius: 6, boxShadow: `2px 2px 0 ${M.ink}`, overflow: "hidden" }}>
              <Photo src="public/photos/fg-02.png" alt="journaling" ratio="1/1" />
            </div>
            <div style={{ position: "absolute", top: -30, right: -20, width: 160, transform: "rotate(2.5deg)", border: `3px solid ${M.ink}`, borderRadius: 6, boxShadow: `2px 2px 0 ${M.ink}`, overflow: "hidden" }}>
              <Photo src="public/photos/fg-03.png" alt="groupe BAFA" ratio="1/1" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "100px 48px", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 80, background: M.cream, borderBottom: `1.5px solid ${M.ink}` }}>
        <div>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.6, opacity: 0.85, marginBottom: 32 }}>Tout au long de la formation vous aurez l'occasion de :</p>
        ...
        <div style={{ position: "sticky", top: 100, alignSelf: "flex-start" }}>
          <div style={{ background: M.yellow, padding: 32, borderRadius: 24, border: `2px solid ${M.ink}`, boxShadow: `4px 4px 0 ${M.ink}` }}>
      ...
      <div style={{ background: M.ochre, color: M.ink, padding: "60px 48px", position: "relative", borderBottom: `2px solid ${M.ink}`, overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            ...
            <div className="hand" style={{ fontSize: 38, color: M.red, marginBottom: -10, transform: "rotate(-1.5deg)" }}>direction</div>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 32, flexWrap: "wrap" }}>
              <button style={{ background: M.ink, color: M.yellow, border: "none", borderRadius: 999, padding: "16px 26px", fontSize: 14, fontWeight: 700, letterSpacing: 0.5, textTransform: "uppercase", cursor: "pointer", boxShadow: `2px 2px 0 ${M.cream}` }}>
                Je m'inscris (450 €) →
              </button>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ background: M.cream, padding: 14, borderRadius: 12, border: `3px dashed ${M.ink}`, boxShadow: `4px 4px 0 ${M.ink}`, transform: "rotate(1deg)", position: "relative" }}>
            ...
            <div style={{ position: "absolute", bottom: -36, left: -28, width: 140, transform: "rotate(-3.5deg)", border: `3px solid ${M.ink}`, borderRadius: 6, boxShadow: `2px 2px 0 ${M.ink}`, overflow: "hidden" }}>
              <Photo src="public/APPRO/2.jpeg" alt="APPRO 2" ratio="1/1" />
            </div>
            <div style={{ position: "absolute", top: -22, right: -30, transform: "rotate(4deg)" }}>
              <div style={{ width: 90, height: 90, borderRadius: "50%", background: M.red, color: M.cream, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", border: `3px solid ${M.ink}`, boxShadow: `2px 2px 0 ${M.ink}`, textAlign: "center" }}>
      ...
      <div style={{ background: M.ink, color: M.cream, padding: "40px 48px", borderBottom: `2px solid ${M.ink}` }}>
        <div style={{ display: "grid", gridTemplateColumns: "auto 1fr auto", gap: 32, alignItems: "center", maxWidth: 1280 }}>
          ...
          <div style={{ fontSize: 17, lineHeight: 1.5 }}>
            Cette formation est <strong>l'étape 3 du BAFA</strong>. Vous devez avoir validé votre <span style={{ color: M.ochre, fontWeight: 600 }}>formation générale</span> et un <span style={{ color: M.ochre, fontWeight: 600 }}>stage pratique d'au moins 14 jours</span> pour vous inscrire.
          </div>
      ...
      <div style={{ padding: "100px 48px", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 80, background: M.cream, borderBottom: `1.5px solid ${M.ink}` }}>
        <div>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.6, opacity: 0.85, marginBottom: 40 }}>
            Vous approfondissez vos acquis BAFA <strong>tout en</strong> vous spécialisant sur les enjeux d'un séjour à l'étranger / échange de jeunes.
          </p>

          {/* Bloc 1 : Affiner votre posture */}
          <div style={{ background: M.paper, border: `2px solid ${M.ink}`, borderRadius: 24, padding: 28, marginBottom: 24, boxShadow: `3px 3px 0 ${M.violet}` }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
              ...
              <h3 className="ed" style={{ fontSize: 28, fontWeight: 600, fontStyle: "italic", margin: 0, letterSpacing: -1 }}>Affiner votre posture d'animateur·rice</h3>
            </div>
          ...
          <div style={{ background: M.paper, border: `2px solid ${M.ink}`, borderRadius: 24, padding: 28, boxShadow: `3px 3px 0 ${M.ochre}` }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
        ...
        {/* Sidebar */}
        <div style={{ position: "sticky", top: 100, alignSelf: "flex-start" }}>
          <div style={{ background: M.violet, color: M.cream, padding: 32, borderRadius: 24, border: `2px solid ${M.ink}`, boxShadow: `4px 4px 0 ${M.ink}` }}>
            ...
            <div style={{ marginTop: 16, padding: 14, background: M.ink, color: M.cream, borderRadius: 12 }}>
              ...
              <div style={{ fontSize: 13, marginBottom: 10 }}>L'appro c'est plus rare : on prend 10 min pour répondre à toutes vos questions.</div>
              <button style={{ width: "100%", background: M.ochre, color: M.ink, border: "none", borderRadius: 999, padding: "10px", fontSize: 11, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", cursor: "pointer", fontFamily: "inherit" }}>
                ☎ Demander un rappel
              </button>
            </div>
