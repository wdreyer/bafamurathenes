  ...
  return (
    <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: MM.violet, color: MM.cream, padding: compact ? "10px 12px 18px" : "12px 14px 22px", borderTop: `2px solid ${MM.ink}`, zIndex: 30 }}>
      <button style={{ width: "100%", background: MM.yellow, color: MM.ink, border: "none", borderRadius: 999, padding: "13px 16px", fontSize: 14, fontWeight: 700, letterSpacing: 0.6, textTransform: "uppercase", cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
        <span>☎</span>
        <span>Sois rappelé·e en 30 min</span>
        <span>→</span>
      </button>
...
function MobCallbackFAB() {
  return (
    <div style={{ position: "absolute", bottom: 90, right: 16, zIndex: 25 }}>
      <button style={{ width: 56, height: 56, borderRadius: "50%", background: MM.ochre, color: MM.ink, border: `2.5px solid ${MM.ink}`, boxShadow: `4px 4px 0 ${MM.ink}`, fontSize: 24, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ☎
      </button>
    </div>
  );
...
function MobHome() {
  return (
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      <MobHeader />
      {/* Hero */}
      <div style={{ position: "relative", background: MM.ink, color: MM.cream, padding: "24px 18px 36px", overflow: "hidden", minHeight: 460 }}>
        <PhotoPlaceholder label="bafa.jpg" ratio="auto" color="#3d3550" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} />
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div className="hand" style={{ fontSize: 26, color: MM.yellow, transform: "rotate(-3deg)", marginBottom: -6, marginLeft: 4 }}>passe ton</div>
      ...
      <div style={{ padding: "18px 16px", background: MM.cream }}>
        <div style={{ background: MM.ink, color: MM.cream, borderRadius: 16, padding: 18, border: `2px solid ${MM.violet}`, boxShadow: `4px 4px 0 ${MM.violet}` }}>
          ...
          <div className="ed" style={{ fontSize: 24, fontWeight: 600, fontStyle: "italic", lineHeight: 1.05, marginBottom: 14 }}>
            Une question ? On t'appelle.
          </div>
          <input placeholder="Ton numéro" style={{ width: "100%", background: "transparent", border: `1.5px solid ${MM.cream}33`, borderRadius: 8, padding: "12px 14px", color: MM.cream, fontSize: 15, fontFamily: "inherit", marginBottom: 10, boxSizing: "border-box" }} />
      ...
      <div style={{ padding: "32px 16px 24px", background: MM.cream }}>
        ...
        <div className="hand" style={{ fontSize: 18, color: MM.ink, opacity: 0.7, marginBottom: 20, transform: "rotate(-1deg)" }}>réserve vite ↓</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            <div key={i} style={{ background: MM.paper, border: `1.5px solid ${MM.ink}`, borderRadius: 14, padding: 16, display: "flex", gap: 14 }}>
              <div style={{ flexShrink: 0, width: 44, height: 44, borderRadius: 12, background: v.color, color: MM.cream, display: "flex", alignItems: "center", justifyContent: "center", border: `1.5px solid ${MM.ink}`, transform: "rotate(-3deg)" }}>
  ...
  return (
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      ...
      <div style={{ position: "relative", background: MM.ink, color: MM.cream, padding: "24px 18px 32px", overflow: "hidden", minHeight: 360 }}>
        <PhotoPlaceholder label="pagebafa10.jpg" ratio="auto" color="#3d3550" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} />
        ...
        <div style={{ position: "relative" }}>
          ...
          <h1 style={{ fontSize: 60, fontWeight: 700, letterSpacing: -2.5, lineHeight: 0.9, margin: 0 }}>
            Ton premier pas dans <span className="ed" style={{ fontStyle: "italic", color: MM.ochre }}>l'animation.</span>
          </h1>
      ...
      <div style={{ padding: "32px 16px", background: MM.cream }}>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.6, opacity: 0.85, marginBottom: 14 }}>
          Avec le BAFA, tu donnes vie au collectif : tu construis des projets <strong>avec</strong> et <strong>pour</strong> les jeunes.
        </p>
      ...
      <div style={{ padding: "0 16px 32px", background: MM.cream }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          <div style={{ gridColumn: "1 / 3", border: `2px solid ${MM.ink}`, borderRadius: 14, overflow: "hidden", boxShadow: `4px 4px 0 ${MM.violet}` }}>
            <PhotoPlaceholder label="bafa30.jpg" ratio="16/9" color={MM.sky} />
          </div>
          <div style={{ border: `2px solid ${MM.ink}`, borderRadius: 14, overflow: "hidden", transform: "rotate(-2deg)" }}><PhotoPlaceholder label="bafa1.jpg" ratio="1/1" color={MM.ochre} /></div>
          <div style={{ border: `2px solid ${MM.ink}`, borderRadius: 14, overflow: "hidden", transform: "rotate(2deg)" }}><PhotoPlaceholder label="bafa40.jpg" ratio="1/1" color={MM.green} /></div>
        </div>
      </div>
      ...
      <div style={{ background: MM.violetSoft, padding: "32px 16px", borderTop: `1.5px solid ${MM.ink}` }}>
        ...
        {[
          ...
          { num: "03", color: MM.ochre, title: "Approfondissement", duration: "8 jours", text: "Dernière semaine pour valider ton BAFA. Approfondissement d'une thématique." },
        ].map((s, i) => (
          <div key={i} style={{ background: MM.paper, border: `1.5px solid ${MM.ink}`, borderRadius: 18, padding: 18, marginBottom: 12, boxShadow: `4px 4px 0 ${MM.ink}` }}>
    ...
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      ...
      <div style={{ padding: "20px 16px 0", background: MM.cream }}>
        <div style={{ position: "relative", marginBottom: 28 }}>
          <div style={{ border: `3px solid ${MM.ink}`, borderRadius: 8, boxShadow: `4px 4px 0 ${MM.ink}`, transform: "rotate(2deg)", overflow: "hidden" }}>
            <PhotoPlaceholder label="Panneau Murathènes" ratio="4/3" color="#8a6f4d" />
          </div>
          <div style={{ position: "absolute", bottom: -20, right: -8, width: 100, transform: "rotate(-8deg)", border: `2px solid ${MM.ink}`, borderRadius: 6, boxShadow: `3px 3px 0 ${MM.ink}`, overflow: "hidden" }}>
      ...
      <div style={{ padding: "20px 16px 32px", background: MM.cream }}>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.6, opacity: 0.85, marginBottom: 20 }}>Tout au long, tu auras l'occasion de :</p>
      ...
      {/* Practical box */}
      <div style={{ padding: "0 16px 32px", background: MM.cream }}>
        <div style={{ background: MM.yellow, padding: 22, borderRadius: 18, border: `2px solid ${MM.ink}`, boxShadow: `5px 5px 0 ${MM.ink}` }}>
    ...
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      ...
      <div style={{ background: MM.ochre, color: MM.ink, padding: "24px 18px 28px", borderBottom: `2px solid ${MM.ink}`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div className="hand" style={{ fontSize: 28, color: MM.red, marginBottom: -8, transform: "rotate(-2deg)" }}>direction</div>
      ...
      <div style={{ background: MM.ink, color: MM.cream, padding: "18px 16px" }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.5 }}>
          Tu dois avoir validé ta <strong style={{ color: MM.ochre }}>formation générale</strong> + un <strong style={{ color: MM.ochre }}>stage pratique de 14 jours</strong>.
        </div>
      </div>

      {/* Passport card */}
      <div style={{ padding: "24px 16px 0", background: MM.cream }}>
        <div style={{ background: MM.cream, padding: 12, borderRadius: 12, border: `2.5px dashed ${MM.ink}`, boxShadow: `5px 5px 0 ${MM.ink}` }}>
          ...
          <PhotoPlaceholder label="APPRO/1.jpeg" ratio="4/3" color={MM.green} />
      ...
      <div style={{ padding: "32px 16px 16px", background: MM.cream }}>
        ...
        <div style={{ background: MM.paper, border: `2px solid ${MM.ink}`, borderRadius: 18, padding: 18, marginBottom: 14, boxShadow: `4px 4px 0 ${MM.violet}` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
            ...
            <h3 className="ed" style={{ fontSize: 20, fontWeight: 600, fontStyle: "italic", margin: 0, letterSpacing: -0.5, lineHeight: 1.1 }}>Affiner ta posture</h3>
          </div>
        ...
        <div style={{ background: MM.paper, border: `2px solid ${MM.ink}`, borderRadius: 18, padding: 18, boxShadow: `4px 4px 0 ${MM.ochre}` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
  ...
  return (
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      ...
      <div style={{ position: "relative", background: MM.ink, color: MM.cream, padding: "24px 18px 28px", overflow: "hidden", minHeight: 280 }}>
        <PhotoPlaceholder label="infos.jpg" ratio="auto" color="#3d3550" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(26,21,48,0.4), rgba(26,21,48,0.88))" }} />
        <div style={{ position: "relative" }}>
...
function MobQui() {
  ...
  return (
    <div className="mura" style={{ background: MM.cream, color: MM.ink, minHeight: "100%", paddingBottom: 110, position: "relative" }}>
      ...
      <div style={{ position: "relative", background: MM.ink, color: MM.cream, padding: "24px 18px 28px", overflow: "hidden", minHeight: 280 }}>
        <PhotoPlaceholder label="MT/mew24.jpg" ratio="auto" color="#3d3550" style={{ position: "absolute", inset: 0, height: "100%", aspectRatio: "auto" }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(26,21,48,0.4), rgba(26,21,48,0.88))" }} />
        <div style={{ position: "relative" }}>
