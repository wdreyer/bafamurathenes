...
export default function BafaPage() {
  return (
    <main className="bg-white">
      ...
      {/* LES 3 ÉTAPES */}
<section className="border-t border-slate-100 bg-gradient-to-b from-white via-sky-50 to-[#6668C6]/35">
  <div className="mx-auto max-w-6xl px-4 py-12 md:px-6">
    <header className="mb-8 space-y-3">
      ...
      <p className="max-w-3xl text-base text-slate-700">
        Pour obtenir ton BAFA, tu passes par trois grandes phases. Murathènes te
        propose la formation générale et l’approfondissement “Séjours à l’étranger
        | Echanges de jeunes”. Tu peux également effectuer ton stage pratique avec
        Murathènes ou ses partenaires. Un accompagnement du début à la fin, et même
        au-delà.
      </p>
    </header>
    ...
    <div className="grid gap-5 md:grid-cols-3 items-stretch">
      ...
      <article className="relative flex h-full flex-col overflow-hidden rounded-3xl bg-white/95 p-5 shadow-sm ring-1 ring-sky-100">
        ...
        <div className="relative">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            <p className=" font-semibold" >9 jours pour poser les bases du métier d&apos;anim.</p>
            <p>
              Créer des animations de A à Z : veillées, grands jeux, ateliers,
              temps calmes…
            </p>
            <p>
            ...
            <p>
              Découvrir le fonctionnement des Accueils Collectifs de Mineurs
              (centres de loisirs, séjours de vacances, périscolaire).
            </p>
            <p>
              Réfléchir à la posture d&apos;animateur.ice : Gestion de groupe,
              bienveillance, autorité, gestion des conflits, écoute, sécurité.
            </p>
          </div>
        </div>
      ...
      <article className="relative flex h-full flex-col overflow-hidden rounded-3xl bg-white/95 p-5 shadow-sm ring-1 ring-emerald-100">
        ...
        <div className="relative">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            <p className=" font-semibold">14 jours sur le terrain, auprès d&apos;un vrai public.</p>
            <p>
              Tu rejoins une équipe d’animation dans un centre de loisirs, un
              séjour ou un accueil périscolaire.
            </p>
            <p>
            ...
            <p>
              Tu apprends à travailler avec un·e directeur·rice, des collègues,
              des partenaires.
            </p>
            <p>
              Murathènes t&apos;accompagne dans la recherche de stage grâce à son
      ...
      <article className="relative flex h-full flex-col overflow-hidden rounded-3xl bg-white/95 p-5 shadow-sm ring-1 ring-amber-100">
        ...
        <div className="relative">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            <p className=" font-semibold">Une dernière semaine pour aller plus loin et valider ton BAFA.</p>
            <p>Retours et analyses des stages pratique. Consolider tes acquis</p>
...
>
  <div className="flex items-start justify-between gap-4">
    <div className="min-w-0">
      <div className="text-sm font-semibold text-amber-900 leading-snug">
        Approfondissement séjour à l’étranger, Echanges de jeunes
      </div>

      <p className="mt-2 text-xs font-normal text-slate-600 leading-snug">
        Interculturalité, préparation de projets à l&apos;international, voyage et gestion de trajet
      </p>
    </div>
  ...
  <div className="pointer-events-none absolute opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
          ...
          <p className="mt-3 text-sm text-slate-700">
            Tu peux aussi choisir de faire une qualification pour développer une
            compétence (canoë kayak, surveillance de baignade…)
          </p>
        </div>
  ...
  <div className="mx-auto max-w-6xl px-4 py-12 md:px-6">
    ...
    <div className="grid items-start gap-8 lg:grid-cols-[1.2fr_0.8fr]">
      ...
      <div className="space-y-5 text-base text-slate-700">
        <p>
          Murathènes est une association d&apos;éducation populaire, de formation
          et d&apos;échanges internationaux, née en 2019 à partir d&apos;un constat
          simple : Tous les jeunes n’ont pas accès aux mêmes opportunités de
          loisirs. Or, ils sont des leviers essentiels et émancipateurs,
          permettant aux jeunes de développer pleinement leurs capacités et
          contribuant positivement à leur épanouissement et à leur développement.
        </p>

        <p>
          Nos formations BAFA sont pensées comme des espaces d&apos;émancipation :
          tu y travailles ta posture professionnelle, mais aussi ta confiance,
          ton esprit critique, ta créativité et ta capacité à faire groupe.
        </p>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/95 p-5 shadow-sm ring-1 ring-sky-200">
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-sm text-slate-700">
              Une attention particulière est portée sur la connaissance des
              différents publics, les particularismes de chaque enfant, et sur
              comment faire groupe avec des jeunes d’horizons variés. L’animation
              comme outil d’éducation populaire et d’action sociale.
            </p>
          </div>
        </div>

        <p>
          Murathènes, c’est créer des espaces de joie et de paix où chaque jeune
          existe, compte et est valorisé — peu importe son identité, son genre,
          son orientation sexuelle, ses origines, sa situation administrative,
          économique, scolaire ou professionnelle…
        </p>

        <p className="pt-1 text-xs text-slate-600">
          Les formations BAFA Murathènes sont organisées avec le soutien de
          partenaires institutionnels (DRAJES Auvergne-Rhône-Alpes, Conseil
          départemental du Cantal, dispositifs d&apos;accompagnement de l&apos;ESS, etc.).
        </p>
      </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/95 p-5 shadow-sm ring-1 ring-amber-200">
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-sm text-slate-700">
              ...
              socio-culturel et éducatif en France et en Europe, on t’aide à
              trouver un stage pratique, puis à te projeter vers de nouveaux
              projets : engagement associatif, échanges de jeunes européens,
              volontariat international, séjours et colos…
            </p>
            <p className="mt-3 text-xs text-slate-600">
              Tu ne repars pas juste avec un diplôme, mais avec une expérience de
              groupe forte et des pistes concrètes pour la suite.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-700">
              Création collective (musique, danse, podcast, vidéo, jeu…) en fil
              rouge de la semaine.
            </p>
          </div>
        </div>
      ...
      <div className="rounded-2xl bg-white/95 p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900">Valeurs fortes</p>
            <p className="mt-1 text-sm text-slate-700">
              Consentement, mixité, diversité, travail d&apos;équipe, bienveillance
              et respect.
            </p>
          </div>
        </div>
      ...
      <div className="rounded-2xl bg-white/95 p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900">Cadre de vie</p>
            <p className="mt-1 text-sm text-slate-700">
              Internat en groupe, vie collective, temps informels, moments de
              partage et de respiration.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-white/95 p-5 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-700">
              Échanges de jeunes, séjours à l&apos;étranger, projets européens :
              mobilité &amp; interculturalité.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
          <div className="max-w-3xl space-y-4">
            ...
            <ul className="space-y-2 text-base text-slate-700">
              <li>• Tu dois avoir 16 ans révolus au premier jour de ta formation générale.</li>
              <li>
                • Une attestation de stage pratique d&apos;au moins 14 jours est
                demandée pour l&apos;inscription à l&apos;approfondissement ou à la
                qualification.
              </li>
            </ul>
