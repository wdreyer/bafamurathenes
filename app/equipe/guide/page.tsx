    ...
    <main className="min-h-screen bg-[#f7f8f6] text-slate-950">
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-5 sm:px-6">
        <header className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-5">
          ...
          <Link href="/equipe" className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 no-underline hover:border-slate-400"><ArrowLeft size={16}/>Plannings</Link>
        </header>
